...
# Parsing + Configuration Script – AP - GC Ultrasónico - Rev. A

This **Parsing + Configuration** script is designed for the **AP - GC Ultrasónico** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – AP - GC Ultrasónico Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **AP - GC Ultrasónico** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
